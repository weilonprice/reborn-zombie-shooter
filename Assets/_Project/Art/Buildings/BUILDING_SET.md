...
| | |
|---|---|
| **The Yard** | 13 buildings scattered with long anchors. The balanced baseline. |
| **The Corridors** | 14 in four north-south lanes with an open central corridor. Sightlines run one way and not the other. |
| **The Ring** | 12 — a band at a constant radius, open centre, open rim. You fight in a donut. |
| **The Warren** | 16 on a jittered grid. Short sightlines, corners everywhere. |
...
230k–320k triangles of static geometry per arena, and only one arena is active at a
