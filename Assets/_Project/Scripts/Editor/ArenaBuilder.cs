...
namespace ZombieShooter.EditorTools
{
    ...
    public static class ArenaBuilder
    {
        ...
        const float GroundTileMetres = 12f;

        /// <summary>
        /// The arena floor. Textured rather than flat, and deliberately the quietest surface
        /// in the project.
        /// <para>
        /// It fills most of a 61-degree screen, so every bit of contrast it carries is
        /// contrast competing with the horde. The roster renders at mean luminance 56 across
        /// a wide spread; this sits at 89 across a spread of 23, which keeps bodies separable
        /// on value alone. It is cool where the characters are warm and green, so they also
        /// separate by temperature when a dark archetype crosses a shadow.
        /// </para>
        /// <para>
        /// Generated by ArtSource/Ground/build_ground.py, seamless, and tiled every twelve
        /// metres. If the texture is missing the floor falls back to the flat grey it used to
        /// be rather than turning white.
        /// </para>
        /// </summary>
        static Material CreateGroundMaterial()
        {
            var flat = new Color(0.20f, 0.21f, 0.23f);
            ...
            else
            {
                ...
                Debug.LogWarning($"ArenaBuilder: no ground texture at {GroundAlbedoPath}; " +
                                 "falling back to flat grey. Run ArtSource/Ground/build_ground.py.");
            }
        ...
        /// floor is tiled seven and a half times across the arena and is viewed at a shallow
